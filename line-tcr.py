        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                return
            elif msg.text in ["Key Ian","help","Help"]:
                if wait["lang"] == "JP":
            ...
            elif ("Ian3 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Ian3 gn ","")
                    kc.updateGroup(X)
                else:
            ...
            elif "Ian3 kick " in msg.text:
                midd = msg.text.replace("Ian3 kick ","")
            ...
            elif "Ian3 invite " in msg.text:
                midd = msg.text.replace("Ian3 invite ","")
                ...
                cl.sendMessage(msg)
            elif msg.text in ["Ian1"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': Amid}
                ki.sendMessage(msg)
            elif msg.text in ["Ian2"]:
                msg.contentType = 13
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Ian1 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Ian2 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Ian3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '10'}
            ...
            elif msg.text in ["Ian cancel","Bot cancel"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Ian1 ourl","Ian1 link on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Ian2 ourl","Ian2 link on"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Ian3 ourl","Ian3 link on"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Ian1 curl","Ian1 link off"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Ian2 curl","Ian2 link off"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Ian3 curl","Ian3 link off"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
                ...
                cl.sendText(msg.to,mid)
            elif "Ian1 mid" == msg.text:
                ki.sendText(msg.to,Amid)
            elif "Ian2 mid" == msg.text:
                kk.sendText(msg.to,Bmid)
            elif "Ian3 mid" == msg.text:
                kc.sendText(msg.to,Cmid)
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                ki.sendText(msg.to,"Grouplu Rata Tod")
                                kk.sendText(msg.to,"Grouplu Rata Tod")
                                kc.sendText(msg.to,"Grouplu Rata Tod")
            elif "Nk " in msg.text:
                ...
                if msg.toType == 2:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        ki.sendText(msg.to,"Not found Ian")
                        kk.sendText(msg.to,"Not found Ian")
                        kc.sendText(msg.to,"Not found Ian")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
                                ...
                                ki.sendText(msg.to,"Succes Ian")
                                kk.sendText(msg.to,"Succes Ian")
                                kc.sendText(msg.to,"Succes Ian")
                            except:
                                ki.sendText(msg.to,"Error")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Have a nice dream Ian 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Have a nice dream Ian 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Have a nice dream Ian 􀜁􀅔Har Har􏿿")
